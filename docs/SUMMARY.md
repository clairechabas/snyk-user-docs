...
* [Scan applications](scan-applications/README.md)
  * [Supported languages and frameworks](scan-applications/supported-languages-and-frameworks/README.md)
    ...
    * [Working with Snyk in your environment](scan-applications/supported-languages-and-frameworks/working-with-snyk-in-your-environment/README.md)
      * [Best practices for .NET](scan-applications/supported-languages-and-frameworks/working-with-snyk-in-your-environment/best-practices-for-.net.md)
    ...
    * [.NET](scan-applications/supported-languages-and-frameworks/.net.md)
  ...
  * [Snyk Open Source](scan-applications/snyk-open-source/README.md)
    * [Snyk Open Source - supported languages and package managers](scan-applications/snyk-open-source/snyk-open-source-supported-languages-and-package-managers/README.md)
      * [Snyk for Bazel](scan-applications/snyk-open-source/snyk-open-source-supported-languages-and-package-managers/snyk-for-bazel.md)
    ...
    * [Use Snyk Open Source from the CLI](scan-applications/snyk-open-source/use-snyk-open-source-from-the-cli/README.md)
      ...
      * [Use Snyk Open Source from the CLI: example](scan-applications/snyk-open-source/use-snyk-open-source-from-the-cli/integrate-snyk-into-your-workflow.md)
    * [Starting to fix vulnerabilities](scan-applications/snyk-open-source/starting-to-fix-vulnerabilities/README.md)
      * [Fix your vulnerabilities](scan-applications/snyk-open-source/starting-to-fix-vulnerabilities/fix-your-vulnerabilities.md)
      * [Upgrading package versions to fix vulnerabilities](scan-applications/snyk-open-source/starting-to-fix-vulnerabilities/upgrading-package-versions-fix-vulnerabilities.md)
      * [Snyk patches to fix vulnerabilities](scan-applications/snyk-open-source/starting-to-fix-vulnerabilities/snyk-patches-to-fix-vulnerabilities.md)
    ...
    * [Automatic and manual PRs with Snyk Open Source](scan-applications/snyk-open-source/open-source-basics/README.md)
      * [Automated pull request creation for new fixes](scan-applications/snyk-open-source/open-source-basics/fix-pull-requests-for-new-vulnerabilities.md)
      ...
      * [Upgrading dependencies with automatic PRs](scan-applications/snyk-open-source/open-source-basics/upgrading-dependencies-with-automatic-prs.md)
    ...
    * [Licenses](scan-applications/snyk-open-source/licenses/README.md)
      * [Getting Started with Snyk License Compliance Management](scan-applications/snyk-open-source/licenses/getting-started-snyk-licensing-compliance.md)
  * [Snyk Code](scan-applications/snyk-code/README.md)
    * [Snyk Code benefits and capabilities](scan-applications/snyk-code/snyk-code-benefits-and-capabilities.md)
    * [Snyk Code key features: AI Engine, Web UI, supported integrations](scan-applications/snyk-code/snyk-code-key-features/README.md)
    ...
    * [Getting started with Snyk Code](scan-applications/snyk-code/getting-started-with-snyk-code/README.md)
      * [Prerequisites for Snyk Code](scan-applications/snyk-code/getting-started-with-snyk-code/prerequisites-for-snyk-code.md)
      * [Activating Snyk Code using the Web UI](scan-applications/snyk-code/getting-started-with-snyk-code/activating-snyk-code-using-the-web-ui.md)
      * [Enabling the Snyk Code option in an Organization](scan-applications/snyk-code/getting-started-with-snyk-code/enabling-the-snyk-code-option-in-an-organization.md)
      * [Integrating your Source Control System with your Snyk account](scan-applications/snyk-code/getting-started-with-snyk-code/integrating-your-source-control-system-with-your-snyk-account.md)
      * [Importing repositories for Snyk Code testing](scan-applications/snyk-code/getting-started-with-snyk-code/importing-repositories-for-snyk-code-testing.md)
    * [Snyk Code and your repositories](scan-applications/snyk-code/snyk-code-and-your-repositories/README.md)
      ...
      * [Importing additional repositories to Snyk](scan-applications/snyk-code/snyk-code-and-your-repositories/importing-additional-repositories-to-snyk.md)
      * [Re-importing existing repositories for Snyk Code testing](scan-applications/snyk-code/snyk-code-and-your-repositories/re-importing-existing-repositories-for-snyk-code-testing.md)
      * [Excluding directories and files from the import process](scan-applications/snyk-code/snyk-code-and-your-repositories/excluding-directories-and-files-from-the-import-process.md)
      * [Removing imported repositories from Snyk Code testing](scan-applications/snyk-code/snyk-code-and-your-repositories/removing-imported-repositories-from-snyk-code-testing.md)
    * [Security rules used by Snyk Code](scan-applications/snyk-code/security-rules-used-by-snyk-code/README.md)
      ...
      * [Scala (Beta) rules](scan-applications/snyk-code/security-rules-used-by-snyk-code/scala-beta-rules.md)
      * [Swift (Beta) rules](scan-applications/snyk-code/security-rules-used-by-snyk-code/swift-beta-rules.md)
      * [Visual Basic (Beta) rules](scan-applications/snyk-code/security-rules-used-by-snyk-code/visual-basic-beta-rules.md)
      * [XML rules](scan-applications/snyk-code/security-rules-used-by-snyk-code/xml-rules.md)
    * [Custom rules (beta)](scan-applications/snyk-code/custom-rules-beta/README.md)
      * [How custom rules work](scan-applications/snyk-code/custom-rules-beta/how-custom-rules-work.md)
      * [Getting started with custom rules](scan-applications/snyk-code/custom-rules-beta/getting-started-with-custom-rules.md)
      * [Run query](scan-applications/snyk-code/custom-rules-beta/run-query.md)
      * [Create custom rules](scan-applications/snyk-code/custom-rules-beta/create-custom-rules.md)
      * [The query language](scan-applications/snyk-code/custom-rules-beta/the-query-language.md)
      * [Templates and predicates](scan-applications/snyk-code/custom-rules-beta/templates-and-predicates.md)
      * [List of predefined predicates and templates](scan-applications/snyk-code/custom-rules-beta/list-of-predefined-predicates-and-templates.md)
      * [Query examples](scan-applications/snyk-code/custom-rules-beta/query-examples.md)
      * [Best practices for Snyk Code custom rules](scan-applications/snyk-code/custom-rules-beta/best-practices-for-snyk-code-custom-rules.md)
    * [Exploring and working with Snyk Code results in the Web UI](scan-applications/snyk-code/exploring-and-working-with-snyk-code-results-in-the-web-ui/README.md)
      * [Exploring the Code Analysis page](scan-applications/snyk-code/exploring-and-working-with-snyk-code-results-in-the-web-ui/exploring-the-code-analysis-page/README.md)
        * [Code Analysis page header](scan-applications/snyk-code/exploring-and-working-with-snyk-code-results-in-the-web-ui/exploring-the-code-analysis-page/code-analysis-page-header.md)
        * [Code Analysis page Project summary Information](scan-applications/snyk-code/exploring-and-working-with-snyk-code-results-in-the-web-ui/exploring-the-code-analysis-page/the-code-analysis-page-the-project-summary-information-area.md)
        ...
        * [Code Analysis page vulnerability Issues area](scan-applications/snyk-code/exploring-and-working-with-snyk-code-results-in-the-web-ui/exploring-the-code-analysis-page/code-analysis-page-vulnerability-issues-area.md)
      ...
      * [Exploring the Data flow and Fix analysis pages of an issue](scan-applications/snyk-code/exploring-and-working-with-snyk-code-results-in-the-web-ui/exploring-the-data-flow-and-fix-analysis-pages-of-an-issue/README.md)
        * [Exploring the Data flow page](scan-applications/snyk-code/exploring-and-working-with-snyk-code-results-in-the-web-ui/exploring-the-data-flow-and-fix-analysis-pages-of-an-issue/exploring-the-data-flow-page.md)
        * [Exploring the Fix analysis page](scan-applications/snyk-code/exploring-and-working-with-snyk-code-results-in-the-web-ui/exploring-the-data-flow-and-fix-analysis-pages-of-an-issue/exploring-the-fix-analysis-page.md)
      * [Understanding the Priority Score of Snyk Code issues](scan-applications/snyk-code/exploring-and-working-with-snyk-code-results-in-the-web-ui/understanding-the-priority-score-of-snyk-code-issues.md)
      * [Understanding the Severity Score of Snyk Code Issues](scan-applications/snyk-code/exploring-and-working-with-snyk-code-results-in-the-web-ui/understanding-the-severity-score-of-snyk-code-issues.md)
      * [Exploring the history of Snyk Code results](scan-applications/snyk-code/exploring-and-working-with-snyk-code-results-in-the-web-ui/exploring-the-history-of-snyk-code-results.md)
      * [Sharing your feedback on Snyk Code](scan-applications/snyk-code/exploring-and-working-with-snyk-code-results-in-the-web-ui/sharing-your-feedback-with-snyk-code.md)
    * [Using Snyk Code from the CLI](scan-applications/snyk-code/using-snyk-code-from-the-cli/README.md)
      * [Set the Snyk Organization for the CLI tests](scan-applications/snyk-code/using-snyk-code-from-the-cli/set-the-snyk-organization-for-the-cli-tests/README.md)
        * [Setting the default Organization for all CLI tests](scan-applications/snyk-code/using-snyk-code-from-the-cli/set-the-snyk-organization-for-the-cli-tests/setting-the-default-organization-for-all-cli-tests.md)
        * [Finding the Snyk ID and internal name of an Organization](scan-applications/snyk-code/using-snyk-code-from-the-cli/set-the-snyk-organization-for-the-cli-tests/finding-the-snyk-id-and-internal-name-of-an-organization.md)
        * [Setting an Organization for a specific CLI test](scan-applications/snyk-code/using-snyk-code-from-the-cli/set-the-snyk-organization-for-the-cli-tests/setting-an-organization-for-a-specific-cli-test.md)
      * [Testing your source code using the CLI](scan-applications/snyk-code/using-snyk-code-from-the-cli/testing-your-source-code-using-the-cli.md)
      * [Publishing Snyk Code CLI results to a Snyk Project and ignoring CLI results (beta)](scan-applications/snyk-code/using-snyk-code-from-the-cli/publishing-cli-results-to-a-snyk-project-and-ignoring-cli-results.md)
      * [Excluding directories and files from the Snyk Code CLI test](scan-applications/snyk-code/using-snyk-code-from-the-cli/excluding-directories-and-files-from-the-snyk-code-cli-test.md)
      * [Understanding the Snyk Code CLI results](scan-applications/snyk-code/using-snyk-code-from-the-cli/snyk-code-cli-results.md)
      * [Working with the Snyk Code CLI results](scan-applications/snyk-code/using-snyk-code-from-the-cli/working-with-the-snyk-code-cli-results/README.md)
        * [Displaying only discovered issues above a specific severity level](scan-applications/snyk-code/using-snyk-code-from-the-cli/working-with-the-snyk-code-cli-results/displaying-only-discovered-issues-above-a-specific-severity-level.md)
        * [Outputting the test results to JSON or SARIF format in the terminal](scan-applications/snyk-code/using-snyk-code-from-the-cli/working-with-the-snyk-code-cli-results/outputting-the-test-results-to-json-or-sarif-format-in-the-terminal.md)
      ...
      * [Displaying the CLI results in an HTML format using the Snyk-to-HTML feature](scan-applications/snyk-code/using-snyk-code-from-the-cli/displaying-the-cli-results-in-an-html-format-using-the-snyk-to-html-feature/README.md)
        * [Installing the Snyk-to-Html tool](scan-applications/snyk-code/using-snyk-code-from-the-cli/displaying-the-cli-results-in-an-html-format-using-the-snyk-to-html-feature/installing-the-snyk-to-html-tool.md)
        * [Running the snyk-to-html command](scan-applications/snyk-code/using-snyk-code-from-the-cli/displaying-the-cli-results-in-an-html-format-using-the-snyk-to-html-feature/running-the-snyk-to-html-command.md)
        * [Viewing the HTML results](scan-applications/snyk-code/using-snyk-code-from-the-cli/displaying-the-cli-results-in-an-html-format-using-the-snyk-to-html-feature/viewing-the-html-results.md)
    * [Using Snyk Code from a CI/CD pipeline](scan-applications/snyk-code/using-snyk-code-from-a-ci-cd-pipeline.md)
    * [Using Snyk Code in an IDE](scan-applications/snyk-code/using-snyk-code-in-an-ide.md)
    * [Deployment options for Snyk Code](scan-applications/snyk-code/deployment-options.md)
    * [Snyk Code Local Engine](scan-applications/snyk-code/snyk-code-local-engine.md)
    * [Fix code issues automatically with DeepCode AI Fix Suggestions](scan-applications/snyk-code/fix-code-issues-automatically-with-deepcode-ai-fix-suggestions.md)
    * [Snyk Code - Additional resources](scan-applications/snyk-code/snyk-code-additional-resources.md)
  * [Snyk Container](scan-applications/snyk-container/README.md)
    * [Getting started with Snyk Container](scan-applications/snyk-container/getting-started-with-snyk-container.md)
    * [How Snyk Container works](scan-applications/snyk-container/how-snyk-container-works/README.md)
      ...
      * [Understanding the severity levels of detected Linux vulnerabilities](scan-applications/snyk-container/how-snyk-container-works/understanding-linux-vulnerability-severity.md)
    * [Use Snyk Container](scan-applications/snyk-container/use-snyk-container/README.md)
      * [Base image detection](scan-applications/snyk-container/use-snyk-container/base-image-detection.md)
      * [Image layer information](scan-applications/snyk-container/use-snyk-container/image-layer-information.md)
      ...
      * [Analysis and fixes for your images from the Snyk Web UI](scan-applications/snyk-container/use-snyk-container/analysis-and-remediation-for-your-images-from-the-snyk-app.md)
      * [Custom Base Image Recommendations](scan-applications/snyk-container/use-snyk-container/custom-base-image-recommendations/README.md)
        * [Case study for Custom Base Image Recommendations](scan-applications/snyk-container/use-snyk-container/custom-base-image-recommendations/case-study-for-custom-base-image-recommendations.md)
        * [Versioning Schema options](scan-applications/snyk-container/use-snyk-container/custom-base-image-recommendations/versioning-schema-options.md)
        * [Custom Versioning Schema for Custom Base Images](scan-applications/snyk-container/use-snyk-container/custom-base-image-recommendations/custom-versioning-schema-for-custom-base-images.md)
      * [Container Project grouping in Project tab](scan-applications/snyk-container/use-snyk-container/container-project-grouping-in-project-tab.md)
    * [Snyk CLI for container security](scan-applications/snyk-container/snyk-cli-for-container-security/README.md)
      * [Understanding Snyk Container CLI results](scan-applications/snyk-container/snyk-cli-for-container-security/understanding-snyk-container-cli-results.md)
      * [Advanced Snyk Container CLI usage](scan-applications/snyk-container/snyk-cli-for-container-security/advanced-snyk-container-cli-usage.md)
    * [Scan your Dockerfile](scan-applications/snyk-container/scan-your-dockerfile/README.md)
      * [Prerequisites for Dockerfile analysis](scan-applications/snyk-container/scan-your-dockerfile/prerequisites-for-dockerfile-analysis.md)
      * [Supported SCMs for Dockerfile analysis](scan-applications/snyk-container/scan-your-dockerfile/supported-scms-for-dockerfile-analysis.md)
      * [Adding your Dockerfile and testing your base image](scan-applications/snyk-container/scan-your-dockerfile/adding-your-dockerfile-and-testing-your-base-image.md)
      * [Detect vulnerable base images from Dockerfile](scan-applications/snyk-container/scan-your-dockerfile/detect-vulnerable-bases-images-from-dockerfile.md)
      * [Automatically link between Dockerfile and images using labels](scan-applications/snyk-container/scan-your-dockerfile/automatically-link-between-dockerfile-and-images-using-labels.md)
      * [Open pull requests to fix vulnerable base images in your Dockerfile](scan-applications/snyk-container/scan-your-dockerfile/open-pull-requests-to-fix-vulnerable-base-images-in-your-dockerfile.md)
    * [Kubernetes integration](scan-applications/snyk-container/kubernetes-integration/README.md)
      * [Kubernetes integration overview](scan-applications/snyk-container/kubernetes-integration/kubernetes-integration-overview/README.md)
        * [Kubernetes integration architecture diagram](scan-applications/snyk-container/kubernetes-integration/kubernetes-integration-overview/kubernetes-integration-architecture-diagram.md)
        * [How Snyk Controller handles your data](scan-applications/snyk-container/kubernetes-integration/kubernetes-integration-overview/how-snyk-controller-handles-your-data.md)
        * [Enable the Kubernetes integration](scan-applications/snyk-container/kubernetes-integration/kubernetes-integration-overview/viewing-your-kubernetes-integration-settings.md)
        * [Supported workloads, Container Registry, languages, OS for Kubernetes integration](scan-applications/snyk-container/kubernetes-integration/kubernetes-integration-overview/supported-container-registry.md)
        * [Disable the Kubernetes integration](scan-applications/snyk-container/kubernetes-integration/kubernetes-integration-overview/disable-the-kubernetes-integration.md)
      * [Snyk Controller installation](scan-applications/snyk-container/kubernetes-integration/snyk-controller-installation/README.md)
        * [Prerequisites for Snyk Controller](scan-applications/snyk-container/kubernetes-integration/snyk-controller-installation/prerequisites-for-snyk-controller.md)
        * [Install the Snyk controller with Helm (Azure and Google Cloud Platform)](scan-applications/snyk-container/kubernetes-integration/snyk-controller-installation/install-the-snyk-controller-with-helm.md)
        * [Install the Snyk controller on Amazon Elastic Kubernetes Service (Amazon EKS)](scan-applications/snyk-container/kubernetes-integration/snyk-controller-installation/install-the-snyk-controller-on-amazon-elastic-kubernetes-service-amazon-eks.md)
        * [Install the Snyk controller with OpenShift 4 and OperatorHub](scan-applications/snyk-container/kubernetes-integration/snyk-controller-installation/install-the-snyk-controller-with-openshift-4-and-operatorhub.md)
        * [Optional installation steps for Snyk Controller with Helm](scan-applications/snyk-container/kubernetes-integration/snyk-controller-installation/optional-installation-steps-for-snyk-controller-with-helm.md)
        * [Private container registry authentication](scan-applications/snyk-container/kubernetes-integration/snyk-controller-installation/private-container-registry-authentication.md)
      * [Kubernetes integration features](scan-applications/snyk-container/kubernetes-integration/kubernetes-integration-features/README.md)
        * [Manually import Kubernetes workload project](scan-applications/snyk-container/kubernetes-integration/kubernetes-integration-features/adding-kubernetes-workloads-for-security-scanning.md)
        * [Automatic import/deletion of Kubernetes workloads projects](scan-applications/snyk-container/kubernetes-integration/kubernetes-integration-features/automatic-import-deletion-of-kubernetes-workloads-projects/README.md)
          * [Advanced use of automatic import/deletion](scan-applications/snyk-container/kubernetes-integration/kubernetes-integration-features/automatic-import-deletion-of-kubernetes-workloads-projects/advanced-use-of-automatic-import-deletion.md)
        * [Annotated import](scan-applications/snyk-container/kubernetes-integration/kubernetes-integration-features/annotated-import.md)
        * [Snyk Sysdig integration](scan-applications/snyk-container/kubernetes-integration/kubernetes-integration-features/snyk-sysdig-integration.md)
      * [Kubernetes integration UI explained](scan-applications/snyk-container/kubernetes-integration/kubernetes-integration-ui-explained/README.md)
        * [Viewing project details and test results](scan-applications/snyk-container/kubernetes-integration/kubernetes-integration-ui-explained/viewing-project-details-and-test-results.md)
        * [Snyk Priority Score and Kubernetes](scan-applications/snyk-container/kubernetes-integration/kubernetes-integration-ui-explained/snyk-priority-score-and-kubernetes.md)
      * [Kubernetes integration FAQ](scan-applications/snyk-container/kubernetes-integration/kubernetes-integration-faq.md)
    * [Snyk Container for self-hosted container registries (with Broker)](scan-applications/snyk-container/integrate-self-hosted-container-registries.md)
  * [PR Checks](scan-applications/run-pr-checks/README.md)
    ...
    * [Troubleshooting PR Checks](scan-applications/run-pr-checks/troubleshooting.md)
* [Scan infrastructure](scan-infrastructure/README.md)
  * [Getting started with Snyk IaC](scan-infrastructure/getting-started-with-snyk-iac/README.md)
    * [Snyk IaC examples](scan-infrastructure/getting-started-with-snyk-iac/snyk-iac-examples.md)
    * [Getting started with IaC+](scan-infrastructure/getting-started-with-snyk-iac/getting-started-with-iac+.md)
  * [Key concepts in IaC+](scan-infrastructure/snyk-iac+/key-concepts-in-iac+.md)
    * [Snyk environments](scan-infrastructure/snyk-iac+/snyk-environments/README.md)
      ...
      * [Find an environment ID](scan-infrastructure/snyk-iac+/snyk-environments/find-an-environment-id.md)
      * [Scan a cloud environment](scan-infrastructure/snyk-iac+/snyk-environments/scan-a-cloud-environment.md)
      * [Update a cloud environment](scan-infrastructure/snyk-iac+/snyk-environments/update-a-cloud-environment.md)
      * [Remove an environment](scan-infrastructure/snyk-iac+/snyk-environments/remove-a-snyk-cloud-environment.md)
    * [Cloud and IaC+ issues](scan-infrastructure/snyk-iac+/cloud-and-integrated-iac-issues/README.md)
      * [View cloud and IaC+ issues in the Snyk Web UI](scan-infrastructure/snyk-iac+/cloud-and-integrated-iac-issues/view-cloud-and-integragted-iac-issues-in-the-snyk-web-ui.md)
      * [Ignoring cloud and IaC+ issues](scan-infrastructure/snyk-iac+/cloud-and-integrated-iac-issues/ignoring-cloud-and-integrated-iac-issues.md)
    * [View resources](scan-infrastructure/snyk-iac+/view-resources.md)
  * [Scan your IaC source code](scan-infrastructure/snyk-infrastructure-as-code/README.md)
    * [Scan Terraform files](scan-infrastructure/snyk-infrastructure-as-code/scan-terraform-files/README.md)
      * [Configure your integration to find security issues in your Terraform files](scan-infrastructure/snyk-infrastructure-as-code/scan-terraform-files/configure-your-integration-to-find-security-issues-in-your-terraform-filess.md)
      * [Scan and fix security issues in Terraform files](scan-infrastructure/snyk-infrastructure-as-code/scan-terraform-files/scan-and-fix-security-issues-in-terraform-files.md)
      * [Terraform variables support](scan-infrastructure/snyk-infrastructure-as-code/scan-terraform-files/terraform-variables-support.md)
      * [Terraform AWS Provider support](scan-infrastructure/snyk-infrastructure-as-code/scan-terraform-files/terraform-aws-provider-support.md)
    * [Scan CloudFormation files](scan-infrastructure/snyk-infrastructure-as-code/scan-cloudformation-files/README.md)
      * [Configure your integration to find security issues in your CloudFormation files](scan-infrastructure/snyk-infrastructure-as-code/scan-cloudformation-files/configure-your-integration-to-find-security-issues-in-your-cloudformation-files.md)
      * [Scan and fix security issues in your CloudFormation files](scan-infrastructure/snyk-infrastructure-as-code/scan-cloudformation-files/scan-and-fix-security-issues-in-your-cloudformation-files.md)
    * [Scan Kubernetes configuration files](scan-infrastructure/snyk-infrastructure-as-code/scan-kubernetes-configuration-files/README.md)
      * [Configure integration to find security issues in Kubernetes configuration files](scan-infrastructure/snyk-infrastructure-as-code/scan-kubernetes-configuration-files/configure-integration-for-security-issues-in-kubernetes-configuration-files.md)
      * [Scan and fix security issues in Kubernetes configuration files](scan-infrastructure/snyk-infrastructure-as-code/scan-kubernetes-configuration-files/scan-and-fix-security-issues-in-kubernetes-configuration-files.md)
      * [Scan and fix security issues in Helm Charts](scan-infrastructure/snyk-infrastructure-as-code/scan-kubernetes-configuration-files/scan-and-fix-security-issues-in-helm-charts.md)
      * [Working with Kubernetes configuration file test results](scan-infrastructure/snyk-infrastructure-as-code/scan-kubernetes-configuration-files/working-with-kubernetes-configuration-file-test-results.md)
    * [Scan ARM configuration files](scan-infrastructure/snyk-infrastructure-as-code/scan-arm-configuration-files.md)
    * [Scan Serverless files](scan-infrastructure/snyk-infrastructure-as-code/scan-serverless-files.md)
    * [Supported IaC and cloud providers](scan-infrastructure/supported-iac-and-cloud-providers.md)
    * [Disable IaC scans per Organization](scan-infrastructure/snyk-infrastructure-as-code/disable-iac-scans.md)
  * [Snyk CLI for Infrastructure as Code](scan-infrastructure/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/README.md)
    * [Test your IaC files](scan-infrastructure/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/test-your-iac-files/README.md)
      ...
      * [Test your Kustomize files with Snyk CLI](scan-infrastructure/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/test-your-iac-files/test-your-kustomize-files-with-snyk-cli.md)
      * [Test your Helm charts with Snyk CLI](scan-infrastructure/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/test-your-iac-files/test-your-helm-charts-with-snyk-cli.md)
    ...
    * [Understanding the IaC CLI test results](scan-infrastructure/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/understanding-the-cli-test-output/README.md)
      * [Snyk IaC CLI test results (v. 1.939.0 and later)](scan-infrastructure/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/understanding-the-cli-test-output/snyk-iac-cli-test-results-v.-1.939.0-and-later.md)
      * [Snyk IaC CLI test results (v. 1.938.0 and earlier)](scan-infrastructure/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/understanding-the-cli-test-output/snyk-iac-cli-test-results-v.-1.938.0-and-earlier.md)
  * [Build your own custom rules](scan-infrastructure/snyk-infrastructure-as-code/custom-rules/README.md)
    * [Install the SDK](scan-infrastructure/snyk-infrastructure-as-code/custom-rules/install-the-sdk.md)
    * [Getting started with the SDK](scan-infrastructure/snyk-infrastructure-as-code/custom-rules/getting-started-with-the-sdk/README.md)
      * [Parsing an input file](scan-infrastructure/snyk-infrastructure-as-code/custom-rules/getting-started-with-the-sdk/parsing-an-input-file.md)
      * [Writing a rule](scan-infrastructure/snyk-infrastructure-as-code/custom-rules/getting-started-with-the-sdk/writing-a-rule.md)
      * [Testing a rule](scan-infrastructure/snyk-infrastructure-as-code/custom-rules/getting-started-with-the-sdk/testing-a-rule.md)
      * [Bundling rules](scan-infrastructure/snyk-infrastructure-as-code/custom-rules/getting-started-with-the-sdk/bundling-rules.md)
      * [Pushing a bundle](scan-infrastructure/snyk-infrastructure-as-code/custom-rules/getting-started-with-the-sdk/pushing-a-bundle.md)
      * [Custom Rego Builtins](scan-infrastructure/snyk-infrastructure-as-code/custom-rules/getting-started-with-the-sdk/advanced-rego.md)
      * [Examples of custom rules](scan-infrastructure/snyk-infrastructure-as-code/custom-rules/getting-started-with-the-sdk/examples.md)
    * [Use IaC custom rules with CLI](scan-infrastructure/snyk-infrastructure-as-code/custom-rules/use-iac-custom-rules-with-cli/README.md)
      * [Using a local custom rules bundle](scan-infrastructure/snyk-infrastructure-as-code/custom-rules/use-iac-custom-rules-with-cli/using-a-local-custom-rules-bundle.md)
      * [Using a remote custom rules bundle](scan-infrastructure/snyk-infrastructure-as-code/custom-rules/use-iac-custom-rules-with-cli/using-a-remote-custom-rules-bundle.md)
    * [Integrating IaC custom rules within a pipeline](scan-infrastructure/snyk-infrastructure-as-code/custom-rules/integrating-iac-custom-rules-within-a-pipeline.md)
    * [SDK reference](scan-infrastructure/snyk-infrastructure-as-code/custom-rules/sdk-reference.md)
  * [Build your own IaC to cloud custom rules](scan-infrastructure/snyk-iac+/build-your-own-iac+-to-cloud-custom-rules/README.md)
    * [Create a Custom Rules Project](scan-infrastructure/snyk-iac+/build-your-own-iac+-to-cloud-custom-rules/create-a-custom-rules-project.md)
    * [Create a Custom Rule](scan-infrastructure/snyk-iac+/build-your-own-iac+-to-cloud-custom-rules/create-a-custom-rule.md)
    * [(Recommended) Write a Custom Rule Spec (Unit Test)](scan-infrastructure/snyk-iac+/build-your-own-iac+-to-cloud-custom-rules/recommended-write-a-custom-rule-spec-unit-test.md)
    * [(Recommended) Test your Custom Rule](scan-infrastructure/snyk-iac+/build-your-own-iac+-to-cloud-custom-rules/recommended-test-your-custom-rule.md)
    * [Build, bundle, and upload your Custom Rules](scan-infrastructure/snyk-iac+/build-your-own-iac+-to-cloud-custom-rules/build-bundle-and-upload-your-custom-rules.md)
    * [Enforce your Custom Rules](scan-infrastructure/snyk-iac+/build-your-own-iac+-to-cloud-custom-rules/enforce-your-custom-rules.md)
    * [Explore example Custom Rules](scan-infrastructure/snyk-iac+/build-your-own-iac+-to-cloud-custom-rules/explore-example-custom-rules.md)
  * [Cloud functionality in IaC+](scan-infrastructure/snyk-iac+/README.md)
    ...
    * [Supported resources for cloud context in Snyk IaC](scan-infrastructure/snyk-iac+/supported-resources-for-cloud-context-in-snyk-iac/README.md)
    ...
    * [Detect drift and manually created resources](scan-infrastructure/snyk-infrastructure-as-code/detect-drift-and-manually-created-resources/README.md)
      ...
      * [Configure cloud providers](scan-infrastructure/snyk-infrastructure-as-code/detect-drift-and-manually-created-resources/configure-cloud-providers/README.md)
        * [Configure AWS provider](scan-infrastructure/snyk-infrastructure-as-code/detect-drift-and-manually-created-resources/configure-cloud-providers/configure-aws-provider.md)
        * [Configure Azure provider](scan-infrastructure/snyk-infrastructure-as-code/detect-drift-and-manually-created-resources/configure-cloud-providers/configure-azure-provider.md)
        * [Configure GitHub provider](scan-infrastructure/snyk-infrastructure-as-code/detect-drift-and-manually-created-resources/configure-cloud-providers/configure-github-provider.md)
        * [Configure Google provider](scan-infrastructure/snyk-infrastructure-as-code/detect-drift-and-manually-created-resources/configure-cloud-providers/configure-google-provider.md)
      * [Supported resources](scan-infrastructure/snyk-infrastructure-as-code/detect-drift-and-manually-created-resources/supported-resources/README.md)
        * [AWS resources](scan-infrastructure/snyk-infrastructure-as-code/detect-drift-and-manually-created-resources/supported-resources/aws-resources.md)
        * [Azure resources](scan-infrastructure/snyk-infrastructure-as-code/detect-drift-and-manually-created-resources/supported-resources/azure-resources.md)
        * [GitHub resources](scan-infrastructure/snyk-infrastructure-as-code/detect-drift-and-manually-created-resources/supported-resources/github-resources.md)
        * [Google resources](scan-infrastructure/snyk-infrastructure-as-code/detect-drift-and-manually-created-resources/supported-resources/google-resources.md)
      * [Detect and report infrastructure drift](scan-infrastructure/snyk-infrastructure-as-code/detect-drift-and-manually-created-resources/detect-and-report-infrastructure-drift.md)
      ...
      * [Filter rules](scan-infrastructure/snyk-infrastructure-as-code/detect-drift-and-manually-created-resources/filter-rules.md)
      * [Ignore resources for drift](scan-infrastructure/snyk-infrastructure-as-code/detect-drift-and-manually-created-resources/ignore-resources.md)
      * [IAC sources usage](scan-infrastructure/snyk-infrastructure-as-code/detect-drift-and-manually-created-resources/iac-sources-usage.md)
    * [Manage cloud and IaC+ rules](scan-infrastructure/snyk-iac+/manage-cloud-and-iac+-rules.md)
  * [View compliance reporting](scan-infrastructure/snyk-iac+/view-compliance-reporting.md)
  * [View Infrastructure as Code issue reports](scan-infrastructure/view-infrastructure-as-code-issue-reports.md)
...
* [Manage issues](manage-issues/README.md)
  * [Snyk Projects](manage-issues/snyk-projects/README.md)
    ...
    * [Project tags](manage-issues/snyk-projects/project-tags.md)
    * [Project collections groupings](manage-issues/snyk-projects/project-collections-groupings/README.md)
  ...
  * [Priorities for fixing issues](manage-issues/priorities-for-fixing-issues/README.md)
  ...
  * [Policies](manage-issues/policies/README.md)
    ...
    * [Assign policies to Projects](manage-issues/policies/assign-policies-to-projects.md)
    * [Assign a policy to an Organization](manage-issues/policies/assign-a-policy-to-an-organization.md)
...
* [Snyk CLI](snyk-cli/README.md)
  ...
  * [Install or update the Snyk CLI](snyk-cli/install-or-update-the-snyk-cli/README.md)
    ...
    * [Prerequisite for CLI on an Apple M1 machine](snyk-cli/install-or-update-the-snyk-cli/prerequisite-for-cli-on-an-apple-m1-machine.md)
